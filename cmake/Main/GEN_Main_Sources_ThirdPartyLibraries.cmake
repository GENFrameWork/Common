...
if(SND_FEATURE)  
  ...
  if(COMPILE_FOR_WINDOWS)  
    ...
    list(APPEND GEN_INCLUDES_DIR_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL_INCLUDE}/windows") 
  ...
  if(COMPILE_FOR_LINUX)  
    ...
    if(COMPILE_FOR_LINUX_INTEL_64)
      ...
      list(APPEND GEN_INCLUDES_DIR_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL_INCLUDE}/linux") 
    ...
    if(COMPILE_FOR_LINUX_ARM        OR      
       ...
       COMPILE_FOR_LINUX_ARM_RPI_64)    

      list(APPEND GEN_INCLUDES_DIR_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL_INCLUDE}/linux_arm") 
  ...
  list(APPEND GEN_INCLUDES_DIR_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common") 
  
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/auxeffectslot.cpp")    
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/buffer.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/debug.cpp")  
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/error.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/event.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effect.cpp")   
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/extension.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/filter.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/listener.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/source.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/state.cpp")

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/autowah.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/chorus.cpp")    
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/compressor.cpp")   
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/convolution.cpp")   
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/dedicated.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/distortion.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/echo.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/effects.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/equalizer.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/fshifter.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/modulator.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/null.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/pshifter.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/reverb.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/effects/vmorpher.cpp")

  if(COMPILE_FOR_WINDOWS)  

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/eax/api.cpp")   
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/eax/call.cpp")   
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/eax/exception.cpp")    
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/eax/fx_slot_index.cpp")    
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/eax/fx_slots.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/al/eax/utils.cpp")

  endif()

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/alc.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/alu.cpp")    
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/alconfig.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/context.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/device.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/events.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/panning.cpp")

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/base.cpp")    
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/loopback.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/null.cpp")

  if(COMPILE_FOR_WINDOWS)  

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/winmm.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/dsound.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/wasapi.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/wave.cpp")

  endif()

  if(COMPILE_FOR_LINUX)  
  
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/alsa.cpp")	
	  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/oss.cpp")
	  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/pulseaudio.cpp")
	  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/backends/wave.cpp")

  endif()

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/autowah.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/chorus.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/compressor.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/convolution.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/dedicated.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/distortion.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/echo.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/equalizer.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/fshifter.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/modulator.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/null.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/pshifter.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/reverb.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/alc/effects/vmorpher.cpp")

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/alcomplex.cpp") 
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/alfstream.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/almalloc.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/alsem.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/alstring.cpp")  
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/althrd_setname.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/dynload.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/pffft.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/polyphase_resampler.cpp")      
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/ringbuffer.cpp")     
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/common/strutils.cpp")

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/ambdec.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/ambidefs.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/bformatdec.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/bs2b.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/bsinc_tables.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/buffer_storage.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/context.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/converter.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/cpu_caps.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/cubic_tables.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/devformat.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/device.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/effectslot.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/except.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/filters/biquad.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/filters/nfc.cpp")   
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/filters/splitter.cpp")   
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/fmt_traits.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/fpu_ctrl.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/helpers.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/hrtf.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/logging.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mastering.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mixer.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/uhjfilter.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/uiddefs.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/voice.cpp")

  if(COMPILE_FOR_LINUX)  

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/dbus_wrap.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/rtkit.cpp")

  endif()

	list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mixer/mixer_c.cpp")

  if(COMPILE_FOR_WINDOWS OR COMPILE_FOR_LINUX_INTEL_64)

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mixer/mixer_sse.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mixer/mixer_sse2.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mixer/mixer_sse3.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mixer/mixer_sse41.cpp")
  ...
  if(COMPILE_FOR_LINUX_ARM        OR      
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_OPENAL}/core/mixer/mixer_neon.cpp")
