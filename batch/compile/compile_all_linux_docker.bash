...
bash -c "docker run -it --rm --name gen_compiler_container -e TARGET=$TARGET -e DEBUG_EXTCFG=$DEBUG_EXTCFG -e MEMORY_EXTCFG=$MEMORY_EXTCFG -e TRACE_EXTCFG=$TRACE_EXTCFG -e FEEDBACK_EXTCFG=$FEEDBACK_EXTCFG -e IMAGEBASE=$IMAGEBASE -e PATHLISTAPP=$PATHLISTAPP -v $BIND_MOUNT_GEN $COMPILE_IMAGE"
