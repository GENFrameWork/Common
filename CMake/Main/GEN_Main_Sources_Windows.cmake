# --------------------------------------------------------------------
# GEN_Main_Sources_Windows.cmake
# Main: Sources Windows
# --------------------------------------------------------------------
...
if(GRP_FEATURE)       
  ...
  if(GRP_DESKTOPMANAGER_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_PLATFORMS_WINDOWS}/GRPWINDOWSDesktopManager.cpp")
...
if(DIO_WINDOWSWFP_FEATURE)
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_PLATFORMS_WINDOWS}/DIOWINDOWSWFP.cpp")
...
if(DIO_NOTIFICATIONS_MANAGER_FEATURE)
  ...
  list(APPEND GEN_THIRDPARTY_LIBRARYS WinToast)

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_WINTOAST_SOURCE}/wintoastlib.cpp")
  
  set(GEN_TPL_SOURCES)

  list(APPEND GEN_TPL_SOURCES "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_WINTOAST_SOURCE}/wintoastlib.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST ${GEN_TPL_SOURCES})

  GEN_ThirdPartyLibraries_SuppressWarnings(WinToast ${GEN_TPL_SOURCES})
...
if(DIO_STREAMTCPIP_FEATURE)
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_PLATFORMS_WINDOWS}/DIOWINDOWSStreamTCPIPServer.cpp") 
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_PLATFORMS_WINDOWS}/DIOWINDOWSStreamIPLocalEnumDevices.cpp")
...
if(DIO_OSPIPELINE_FEATURE)
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_PLATFORMS_WINDOWS}/DIOWINDOWSOSPipeline.cpp")
...
if(WINDOWS_XWINGET_FEATURE)

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_PLATFORMS_WINDOWS}/XWINDOWSWinget.cpp")
