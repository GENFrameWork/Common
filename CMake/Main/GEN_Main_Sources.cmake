...
if(USERINTERFACE_FEATURE)
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_Style.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_PropertyRegistry.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_Length.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_ComputedStyle.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_LayoutBox.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_LayoutEngine.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_StyleSheet.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE}/UI_CSSParser.cpp") 
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE_ELEMENTS}/UI_Element_ProgressImage.cpp")   
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE_ELEMENTS}/UI_Element_ProgressRadial.cpp")
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_USERINTERFACE_ELEMENTS}/UI_Element_StatisticsChart.cpp")
...
if(DATABASES_SQL_FEATURE)  
  ...
  if(DATABASES_SQL_SQLITE_FEATURE)
    ...
    list(APPEND GEN_THIRDPARTY_LIBRARYS SQLite)
    set(GEN_TPL_SOURCES)
    list(APPEND GEN_TPL_SOURCES "${GEN_DIRECTORY_THIRDPARTYLIBRARIES_SQLITE}/sqlite3.c")
    list(APPEND GEN_SOURCES_MODULES_LIST ${GEN_TPL_SOURCES})
    GEN_ThirdPartyLibraries_SuppressWarnings(SQLite ${GEN_TPL_SOURCES})
...
if(GRP_FEATURE)
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC}/GRPScreenCFGChromes.cpp")
  ...
  if(GRP_OPENGL_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_OPENGL}/GRPEGLContext.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_OPENGL}/GRPBlitGLES.cpp")
  ...
  if(GRP_VECTOR_FILE_SVG_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGConfig.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGTransform.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGCSSStyleSheet.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGStyle.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObj.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVG.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjRect.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjCircle.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjEllipse.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjLine.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjPolyLine.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjPolygon.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjPath.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjUse.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjGradient.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_FORMATFILES_VECTOR_SVG}/GRPVectorFileSVGObjText.cpp")
  ...
  if(GRP_STATISTICSCHARS_FEATURE)
      ...
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChart.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartBuilderSVG.cpp")

      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartColumns.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartLines.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartArea.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartBars.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartStackedColumns.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartPie.cpp")

      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartColumns3D.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartLines3D.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartArea3D.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartBars3D.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartStackedColumns3D.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_STATISTICSCHARS}/GRPStatisticsChartPie3D.cpp")
  ...
  if(GRP_2D_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_2D}/GRP2DCanvas.cpp")
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_2D}/GRP2DPath.cpp")

    
    if(GRP_VECTOR_FILE_DXF_FEATURE OR GRP_VECTOR_FILE_SVG_FEATURE)

      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_2D}/GRP2DVectorFileRenderAGG.cpp")

      if(GRP_VECTOR_FILE_DXF_FEATURE)

        list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_2D}/GRP2DVectorFileDXFRenderAGG.cpp")
      ...
      if(GRP_VECTOR_FILE_SVG_FEATURE)
        ...
        list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_GRAPHIC_2D}/GRP2DVectorFileSVGRenderAGG.cpp")
...
if(DIO_FEATURE)
  ...
  if(DIO_STREAMTLS_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS13KeySchedule.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS13Session.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS13HandshakeClient.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS13HandshakeServer.cpp")

  endif()

  # These classes are shared by TLS 1.3 and the optional TLS 1.2 client.
  # Keep them in a common block so TLS 1.2-only builds have the same support.
  if(DIO_STREAMTLS_FEATURE OR DIO_STREAMTLS12_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLSRecord.cpp")
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLSMessagesHandShakeServerFlight.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLSSignature.cpp")

  endif()


  # TLS 1.2 (RFC 5246) parallel-class implementation. Kept as its own guarded block, separate from the
  # DIO_STREAMTLS_FEATURE list above, because it is a self-contained set of classes (never a modification
  # of the TLS 1.3 ones) that a target can turn off independently -- see DIO_STREAMTLS12_FEATURE in
  # GEN_Main_Dependencies.cmake.
  if(DIO_STREAMTLS12_FEATURE)

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS12Messages.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS12KeySchedule.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS12Record.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS12Session.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS_TLS}/DIOStreamTLS12HandshakeClient.cpp")
  ...
  if(DIO_STREAM_FEATURE)
    ...
    if(DIO_STREAMTCPIP_FEATURE)
      ...
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_DATAIO_STREAMS}/DIOStreamTCPIPProxy.cpp")
...
list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_XUTILS}/XFString.cpp")
list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_XUTILS}/XBuffer.cpp")
list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_XUTILS}/XBufferBits.cpp")
...
list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_XUTILS}/XThreadListNonPreemptive.cpp")
...
if(XINTERPOLATOR_FEATURE)

  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_XUTILS}/XInterpolator.cpp")
...
if(XFILE_CSV_FEATURE) 
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_XUTILS_FORMATFILES}/XFileCSV.cpp")
...
if(HASH_FEATURE)
  ...
  if(HASH_WHIRLPOOL_FEATURE)
   ...
   if(HASH_HMAC_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/HashHMAC.cpp")
...
if(CIPHER_SYMMETRIC_FEATURE)
  ...
  if(CIPHER_SYMMETRIC_AESGCM_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherAESGCM.cpp")

  endif()

  if(CIPHER_SYMMETRIC_CHACHA20POLY1305_FEATURE)

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherChaCha20Poly1305.cpp")
...
if(CIPHER_HKDF_FEATURE)
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherHKDF.cpp")
...
if(CIPHER_ASYMMETRIC_FEATURE)  
  ...
  # ECDSA and the X.509/credential pipeline are not RSA implementations.
  # Keep them available for Ed25519/ECDSA-only builds as well.
  if(CIPHER_ASYMMETRIC_X25519_FEATURE)

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherKeyECDSA.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherECDSA.cpp")
  ...
  if(CIPHER_ASYMMETRIC_ED25519_FEATURE OR CIPHER_ASYMMETRIC_MLKEM768_FEATURE OR
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherPEMCodec.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherCredentialsLoader.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherCredentialsProvider.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherCertificateX509.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherCertificateX509Validator.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherCertificateX509PathBuilder.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherCertificateX509Revocation.cpp")

    if(CIPHER_ASYMMETRIC_FILEKEY_PEM OR DIO_STREAMTLS_FEATURE OR DIO_STREAMTLS12_FEATURE)
  ...
  if(CIPHER_ASYMMETRIC_ED25519_FEATURE)
    ...
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherEd25519.cpp")

  endif()

  if(CIPHER_ASYMMETRIC_MLKEM768_FEATURE)

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherMLKEM768Core.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherMLKEM768.cpp")

  endif()

  if(CIPHER_ASYMMETRIC_MLKEM1024_FEATURE)

    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherMLKEM1024Core.cpp")
    list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherMLKEM1024.cpp")
  ...
  if(CIPHER_ASYMMETRIC_X25519_FEATURE)
    ...
    if(CIPHER_ASYMMETRIC_MLKEM768_FEATURE)
      ...
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherX25519MLKEM768.cpp")
      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherSecP256r1MLKEM768.cpp")

    endif()

    if(CIPHER_ASYMMETRIC_MLKEM1024_FEATURE)

      list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_CIPHER}/CipherSecP384r1MLKEM1024.cpp")
...
if(COMPRESS_DEFLATE_FEATURE)
  ...
  list(APPEND GEN_SOURCES_MODULES_LIST "${GEN_DIRECTORY_SOURCES_COMPRESS}/CompressDeflate.cpp")
